		...
		<MainStyle>
			<div className="content">
				<div className="profile">
					<Image
						src="/images/profile-new-transp.webp"
						alt=""
					...
					/>
					<Image
						src="/images/anime-profile-pic.webp"
						alt=""
						className="profile-img"
						id="prof-pic"
						width="250"
				...
				<div className="social-buttons">
					...
					<a 
						href={hackthebox_url}
						about="Hack The Box Profile Link"
						>
						<IconButton
							about="Hack The Box Profile Link"
							>
